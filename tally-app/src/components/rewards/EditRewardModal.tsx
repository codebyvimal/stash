...
interface EditRewardModalProps {
  ...
  isOpen: boolean;
  onClose: () => void;
  onEdit: (id: string, updates: Partial<Reward>) => void;
  onDelete: (id: string) => void;
  currencyName: string;
}

export function EditRewardModal({ reward, isOpen, onClose, onEdit, onDelete, currencyName }: EditRewardModalProps) {
  ...
  const handleDelete = () => {
    if (reward && confirm('Are you sure you want to delete this reward?')) {
      onDelete(reward.id);
      onClose();
    }
  };
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          >
            <div className="flex items-center justify-between p-6 border-b border-slate-100 dark:border-slate-700">
              <h3 className="text-xl font-bold text-slate-800 dark:text-slate-100">Edit Reward</h3>
            ...
            <form onSubmit={handleSubmit} className="p-6 flex flex-col gap-4">
              ...
              <div className="flex items-center gap-2 mt-2">
                ...
                />
                <label htmlFor="edit-repeatable" className="text-sm font-semibold text-slate-700 dark:text-slate-300 cursor-pointer">
